...
public class CheckoutAddress extends CheckoutBlock {
    public CheckoutAddress(WebDriver webDriver, DefaultElementLocatorFactory parentContext) throws Exception {
